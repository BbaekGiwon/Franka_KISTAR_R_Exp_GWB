...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/prime/Franka_KISTAR_R_Exp_GWB_V1.0/build/_deps/gtest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/prime/Franka_KISTAR_R_Exp_GWB_V1.0/build/_deps/gtest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
